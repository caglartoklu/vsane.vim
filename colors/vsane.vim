...
" FILE: vsane.vim
" PLUGINTYPE: color
" DESCRIPTION: A sane and light Vim colorscheme similar to Visual Studio
...
hi StatusLine   guifg=black     guibg=#d0d0d0 gui=bold
hi StatusLineNC guifg=black     guibg=#d0d0d0 gui=none
